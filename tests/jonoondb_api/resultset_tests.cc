...
TEST(Resultset, GetColumnType) {
  ...
  while (rs.Next()) {
    ...
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("field15.field1")),
              SqlType::INTEGER);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("field15.field2")),
              SqlType::INTEGER);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field1")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field2")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field3")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field4")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field5")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field6")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field7")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field8")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field9")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field10")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field11")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field12")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field13")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field15.field1")),
              SqlType::DB_NULL);
    ASSERT_EQ(rs.GetColumnType(rs.GetColumnIndex("nestedField.field15.field2")),
              SqlType::DB_NULL);
  }
}
