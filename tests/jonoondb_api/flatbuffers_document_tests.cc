...
void CompareObjects(const FlatbuffersDocument &fbDoc, const AllFieldType& allFieldObj) {
  ...
  ASSERT_EQ(fbDoc.GetIntegerValueAsInt64("field3"), allFieldObj.field3() ? 1 : 0);  
  ...
  ASSERT_STREQ(fbDoc.GetStringValue("field11").c_str(), allFieldObj.field11()->c_str());
  // Check rest of the fields
  auto subDoc = fbDoc.AllocateSubDocument();
  fbDoc.GetDocumentValue("nestedField", *subDoc);
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field1"), allFieldObj.nestedField()->field1());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field2"), allFieldObj.nestedField()->field2());
  ASSERT_EQ(fbDoc.GetIntegerValueAsInt64("field3"), allFieldObj.field3() ? 1 : 0);
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field4"), allFieldObj.nestedField()->field4());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field4"), allFieldObj.nestedField()->field4());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field5"), allFieldObj.nestedField()->field5());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field6"), allFieldObj.nestedField()->field6());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field7"), allFieldObj.nestedField()->field7());
  ASSERT_EQ(subDoc->GetFloatingValueAsDouble("field8"), allFieldObj.nestedField()->field8());
  ASSERT_EQ(subDoc->GetIntegerValueAsInt64("field9"), allFieldObj.nestedField()->field9());  
  ASSERT_EQ(subDoc->GetFloatingValueAsDouble("field10"), allFieldObj.nestedField()->field10());
  ASSERT_STREQ(subDoc->GetStringValue("field11").c_str(), allFieldObj.nestedField()->field11()->c_str());
}
