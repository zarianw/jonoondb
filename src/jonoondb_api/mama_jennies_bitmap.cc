...
MamaJenniesBitmap::MamaJenniesBitmap() : m_ewahBoolArray(new EWAHBoolArray<size_t>()) {
}
...
MamaJenniesBitmap MamaJenniesBitmap::And(const MamaJenniesBitmap& b1, const MamaJenniesBitmap& b2) {
...
MamaJenniesBitmap MamaJenniesBitmap::Or(const MamaJenniesBitmap& b1, const MamaJenniesBitmap& b2) {
  unique_ptr<EWAHBoolArray<size_t>> container(new EWAHBoolArray<size_t>());
  b1.m_ewahBoolArray->logicalor(*b2.m_ewahBoolArray, *container);
  return MamaJenniesBitmap(container.release()); // move ctor should be called here
}

MamaJenniesBitmap::MamaJenniesBitmap(EWAHBoolArray<size_t>* ewahBoolArray) : m_ewahBoolArray(ewahBoolArray) {
}
