...
JONOONDB_API_EXPORT options_ptr jonoondb_options_copy_construct(const options_ptr other);
...
JONOONDB_API_EXPORT void jonoondb_indexinfo_setisascending(indexinfo_ptr indexInfo, bool value);
JONOONDB_API_EXPORT bool jonoondb_indexinfo_getisascending(indexinfo_ptr indexInfo);
...
JONOONDB_API_EXPORT int64_t jonoondb_resultset_getinteger
