...
#ifndef FLATBUFFERS_GENERATED_INDEX_INFO_FB_JONOONDB_API_H_
#define FLATBUFFERS_GENERATED_INDEX_INFO_FB_JONOONDB_API_H_
...
struct IndexInfoFB : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *columns() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(6); }
  uint8_t is_ascending() const { return GetField<uint8_t>(8, 1); }
  int16_t type() const { return GetField<int16_t>(10, 0); }
  bool Verify(const flatbuffers::Verifier &verifier) const {
    return VerifyTable(verifier) &&
           ...
           VerifyField<int16_t>(verifier, 10 /* type */);
  }
};
...
struct IndexInfoFBBuilder {
  ...
  void add_columns(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> columns) { fbb_.AddOffset(6, columns); }
  ...
  flatbuffers::Offset<IndexInfoFB> Finish() { return flatbuffers::Offset<IndexInfoFB>(fbb_.EndTable(start_, 4)); }
};
...
inline bool VerifyIndexInfoFBBuffer(const flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<IndexInfoFB>(); }
...
#endif  // FLATBUFFERS_GENERATED_INDEX_INFO_FB_JONOONDB_API_H_
